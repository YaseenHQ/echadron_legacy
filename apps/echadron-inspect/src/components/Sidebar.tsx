...
import { ISessionIndex, type SessionSummary } from '@yaseenhq/agent-core-v2/app/sessionIndex/sessionIndex';
import { ISessionLifecycleService } from '@yaseenhq/agent-core-v2/app/sessionLifecycle/sessionLifecycle';
import { IWorkspaceService, type Workspace } from '@yaseenhq/agent-core-v2/app/workspace/workspace';
