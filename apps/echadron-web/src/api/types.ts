// apps/echadron-web/src/api/types.ts
// App-facing camelCase model + EchadronWebApi interface.
 ...
 */
export const COMPACTION_MARKER_METADATA_KEY = 'echadronWeb.compaction';
...
export interface EchadronEventHandlers {
  onEvent(event: AppEvent, meta: EchadronEventMeta): void;
...
export interface EchadronEventMeta {
  sessionId: string;
  seq: number;
  stream?: {
    turnId: number;
...
export interface EchadronEventConnection {
...
// ---------------------------------------------------------------------------
// EchadronWebApi — the app-facing interface
// ---------------------------------------------------------------------------
...
export interface EchadronWebApi {
  ...
  connectEvents(handlers: EchadronEventHandlers): EchadronEventConnection;
