// apps/echadron-web/src/composables/messagesToTurns.ts
...
// as several provider-turn blocks. Snapshot messages may omit promptId, so user
...
// ---------------------------------------------------------------------------
// Inline buildApprovalBlock (mirrors the one in useEchadronWebClient.ts; kept
