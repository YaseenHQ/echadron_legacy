 ...
 */
export class EchadronWebviewProvider implements vscode.WebviewViewProvider {
  ...
  createPanel(): vscode.WebviewPanel {
    ...
    const panel = vscode.window.createWebviewPanel("echadronPanel", "Echadron", vscode.ViewColumn.One, {
      enableScripts: true,
