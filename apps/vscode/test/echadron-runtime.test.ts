 ...
 * Wiring: EchadronRuntime and SessionRuntime are real; in-memory Session/KimiHarness fakes form the public SDK boundary.
 * Run: pnpm exec vitest run --config apps/vscode/vitest.config.ts test/echadron-runtime.test.ts
 */
...
import { EchadronRuntime, type OpenSessionOptions } from "../src/runtime/echadron-runtime";
