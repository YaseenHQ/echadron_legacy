...
import { ErrorCodes, KimiError } from '@yaseenhq/echadron-sdk';
...
vi.mock('@yaseenhq/echadron-sdk', async () => {
  const actual = await vi.importActual<typeof import('@yaseenhq/echadron-sdk')>(
