...
import type { ContentPart, ToolCall } from '@yaseenhq/echadron-sdk';
import type { ContextMessage, PromptOrigin } from '@yaseenhq/echadron-sdk';
...
describe('buildExportMarkdown', () => {
  ...
  it('builds complete markdown with frontmatter and overview', () => {
    ...
    expect(md).toContain('# Echadron Session Export');
