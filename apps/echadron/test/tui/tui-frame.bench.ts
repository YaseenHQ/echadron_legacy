 ...
 *
 * Run:
 *   pnpm --filter @yaseenhq/kimi-code exec vitest bench test/tui/tui-frame.bench.ts
 */

import type { Component, Terminal } from '@yaseenhq/pi-tui';
import { TuiMainScreen } from '@yaseenhq/pi-tui';
