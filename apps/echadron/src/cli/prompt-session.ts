/**
 * Minimal harness/session surface consumed by `echadron -p` (print mode).
 *
 ...
 * (`createKimiHarness`, selected by the legacy switch) or the native
 * agent-core-v2 engine (`createKimiHarnessV2`, the default). Both the
