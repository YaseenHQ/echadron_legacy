import { log, type Logger } from '@yaseenhq/echadron-sdk';
import { track as trackTelemetry, type TelemetryProperties } from '@yaseenhq/echadron-telemetry';
...
export async function handleUpgrade(
  ...
  if (target === null) {
    ...
    deps.stdout.write(`Echadron is already up to date (${formatDisplayVersion(currentVersion)}).\n`);
    return 0;
  }
