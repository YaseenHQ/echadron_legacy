...
import type { Component, Focusable } from '@yaseenhq/pi-tui';
import type { KimiHarness, Session, TokenUsage } from '@yaseenhq/echadron-sdk';
...
export interface CacheHintHost {
  ...
  sendNormalUserInput(text: string, preExtracted?: ExtractionResult): void | Promise<void>;
}
