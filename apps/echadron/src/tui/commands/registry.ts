...
import type { AutocompleteItem } from '@yaseenhq/pi-tui';
...
export const BUILTIN_SLASH_COMMANDS = [
  ...
  },
  {
    name: 'settings',
    aliases: ['config'],
    description: 'Open TUI settings: model, permission, theme, editor, features, updates, usage',
    priority: 100,
    availability: 'always',
  },
  {
  ...
  },
  {
    ...
    hidden: true,
    aliases: [],
    description: 'Configure the secondary model for subagents (also in /settings)',
    priority: 90,
    availability: 'always',
  ...
  },
  {
    ...
    description: 'Manage feature defaults and rollback controls (also in /settings)',
    priority: 60,
    availability: 'idle-only',
  },
  {
  ...
  },
  {
    ...
    hidden: true,
    aliases: [],
    description: 'Reload only tui.toml UI preferences (subset of /reload)',
    priority: 60,
    availability: 'always',
  },
  {
  ...
  },
  {
    ...
    hidden: true,
    aliases: [],
    description: 'Set the external editor for Ctrl-G (also in /settings)',
    priority: 60,
    availability: 'always',
  },
  {
    ...
    hidden: true,
    aliases: [],
    description: 'Set the terminal UI theme (also in /settings)',
    priority: 60,
    availability: 'always',
  },
  {
