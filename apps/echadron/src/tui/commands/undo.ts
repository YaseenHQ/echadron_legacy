...
import type { ContextMessage } from '@yaseenhq/echadron-sdk';
import { isKimiError } from '@yaseenhq/echadron-sdk';
...
function renderWelcome(host: SlashCommandHost): void {
  ...
  host.state.transcriptContainer.addChild(
    new WelcomeComponent(host.state.appState, { ui: host.state.ui }),
  );
}
