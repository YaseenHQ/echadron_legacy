...
import type { PluginInfo, PluginMcpServerInfo, PluginSummary } from '@yaseenhq/echadron-sdk';
 ...
 * to proceed with a plugin that Echadron has not reviewed.
 */
export class PluginInstallTrustConfirmComponent extends ChoicePickerComponent {
  constructor(opts: PluginInstallTrustConfirmOptions) {
    super({
      ...
      formatHint: mutedHintLine,
      notice:
        '⚠ This is a third-party plugin that Echadron has not reviewed. It can bundle MCP servers, ' +
