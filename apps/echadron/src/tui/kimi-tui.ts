...
import type { DeviceAuthorization } from '@yaseenhq/echadron-oauth';
...
import type { MigrationPlan } from '@yaseenhq/migration-legacy';
import {
...
export class KimiTUI {
  ...
  sendNormalUserInput(text: string, preExtracted?: ExtractionResult): void {
    ...
    // synchronous unless a hint actually fires.
