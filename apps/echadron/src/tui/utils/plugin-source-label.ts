import type { PluginSummary } from '@yaseenhq/echadron-sdk';
...
/**
 * Returns one of three trust labels for a plugin. Only host-managed plugin zip
...
/**
 * Returns true only for install sources that are unambiguously host-managed
 * official plugins — an https URL under the trusted plugin CDN path.
