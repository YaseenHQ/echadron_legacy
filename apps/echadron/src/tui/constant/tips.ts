...
export const WORKING_TIPS: readonly ToolbarTip[] = [
  ...
  { text: 'ask Echadron to schedule tasks, e.g. "remind me at 5pm"', solo: true, priority: 3 },
...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: '/auto when you want Echadron to handle approvals and keep going unattended' },
  ...
  { text: 'shift-tab to Plan mode to review the approach before Echadron edits files.', priority: 2 },
