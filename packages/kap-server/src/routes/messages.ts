...
import { IMessageLegacyService, isError2, type Scope } from '@yaseenhq/agent-core-v2';
import { messageRoleSchema } from '@yaseenhq/agent-core-v2/agent/contextMemory/protocolMessage';
