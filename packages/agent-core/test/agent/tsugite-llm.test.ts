...
import {
  ...
  type GenerateFn,
} from '../../src/agent/turn/tsugite-llm';
...
describe('TsugiteLLM streaming tool-call deltas', () => {
...
describe('TsugiteLLM response id', () => {
  it('surfaces the provider response id from the generate result', async () => {
    ...
    const llm = new TsugiteLLM({ provider, systemPrompt: 'system', generate });
...
describe('TsugiteLLM stream timing', () => {
...
describe('TsugiteLLM completion budget', () => {
...
describe('downgradeUnsupportedMedia', () => {
  ...
  it('TsugiteLLM strips unsupported video from messages sent to generate', async () => {
