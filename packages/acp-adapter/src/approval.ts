...
import type { ApprovalRequest, ApprovalResponse } from '@yaseenhq/echadron-sdk';
 ...
 *    options surfaced in the TUI by `apps/echadron/src/tui/reverse-rpc/approval/adapter.ts:13`'s
