...
const packageDirs = new Set(['agent-core', 'agent-core-v2', 'kaos', 'klient', 'tsugite', 'node-sdk', 'oauth']);
const workspacePackages = new Map([
  ['@yaseenhq/agent-core-v2', 'agent-core-v2'],
  ['@yaseenhq/agent-core', 'agent-core'],
  ['@yaseenhq/kaos', 'kaos'],
  ['@yaseenhq/echadron-oauth', 'oauth'],
  ['@yaseenhq/klient', 'klient'],
  ['@yaseenhq/tsugite', 'tsugite'],
]);
  ...
  await Promise.all(
    files.map(async (file) => {
      ...
      const updated = providerClientText.replaceAll(
        /(["'])(#\/[^"']+|@yaseenhq\/(?:agent-core-v2|agent-core|kaos|echadron-oauth|klient|tsugite)(?:\/[^"']+)?)\1/g,
