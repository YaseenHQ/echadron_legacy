...
/**
 * Convert a tsugite `ContentPart` to OpenAI-compatible content part.
...
/**
 * Convert a tsugite `Tool` to OpenAI tool format.
 */
...
/**
 * Convert an OpenAI SDK error (or raw Error) to a tsugite `ChatProviderError`.
