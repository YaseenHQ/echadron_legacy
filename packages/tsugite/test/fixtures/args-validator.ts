...
/**
 * Test-only schema validator. Tsugite's e2e tests need a way to validate tool
 * arguments inside the SimpleToolset fixture, but tsugite itself no longer
 * ships a runtime validator (the real one moved to agent-core). Fixtures
 * stick with draft-07 since tsugite's own test schemas don't exercise newer
 * dialects.
 */
