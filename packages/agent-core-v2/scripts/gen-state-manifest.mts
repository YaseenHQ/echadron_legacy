 ...
 *
 * Usage:
 *   pnpm --filter @yaseenhq/agent-core-v2 gen:state-manifest          # write the file
 *   pnpm --filter @yaseenhq/agent-core-v2 gen:state-manifest --check  # freshness check (CI-style)
 *
...
function renderManifest(
  ...
  const out: string[] = [
    ...
    '// Regenerate with: pnpm --filter @yaseenhq/agent-core-v2 gen:state-manifest',
    '//',
