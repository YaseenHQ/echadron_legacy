...
export * from '#/agent/goal/completionReview';
export * from '#/agent/goal/completionGate';
...
import '#/session/goalCompletionReview/profile';
export * from '#/session/goalCompletionReview/goalCompletionReviewService';
import '#/session/goalCompletionGate/configSection';
export * from '#/session/goalCompletionGate/goalCompletionGateService';
