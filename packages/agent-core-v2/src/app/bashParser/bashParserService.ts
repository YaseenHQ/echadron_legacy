 ...
 *
 * Thin adapter over the pure `@yaseenhq/tree-sitter-bash` package: runs
...
import { parse } from '@yaseenhq/tree-sitter-bash';
import type { SyntaxNode } from '@yaseenhq/tree-sitter-bash';
