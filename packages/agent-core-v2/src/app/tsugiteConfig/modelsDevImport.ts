/**
 * `tsugiteConfig` domain (L3) — `IModelsDevImportService`: import providers
 ...
 * → tsugite registries via the persistence bridge); the global
...
import type { ProviderCatalogItem } from '#/tsugite/model/catalog';
