/**
 * `tsugite/provider` domain (L2) — the ONLY composition point from resolved
...
import type { GenerateOptions, VideoUploadInput } from '#/tsugite/contract/provider';
import type { Tool } from '#/tsugite/contract/tool';
import type { ProtocolEndpoint, ResolvedTrait } from '#/tsugite/protocol/protocolTrait';
