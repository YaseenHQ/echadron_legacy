/**
 * `tsugite/provider` domain (L2) — the provider configuration contract.
 *
 ...
 * registry contract; App-scoped. Tsugite has no persistence — it defines
 ...
 * (`app/tsugiteConfig/configSection`). Higher-level services (auth,
...
/**
 * The in-memory provider registry. Tsugite owns the state and the change
