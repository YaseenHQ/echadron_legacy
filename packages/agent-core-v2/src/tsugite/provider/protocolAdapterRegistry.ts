/**
 * `tsugite/provider` domain (L2) — the single production implementation of
...
import { ChatProviderError } from '#/tsugite/contract/errors';
...
} from '#/tsugite/protocol/protocol';
import {
  getProtocolBase,
  listProtocolBases,
  type ProtocolBaseId,
  type ResolvedAdapterIdentity,
} from '#/tsugite/protocol/protocolBase';
import type { ProtocolTrait, ResolvedTrait, TraitContext } from '#/tsugite/protocol/protocolTrait';
