/**
 * `tsugite/model` domain (L2) — the `IModelCatalog.inspect` payload and its
 * assembly.
 *
...
import type { InspectionSource, ResolutionTrace } from '#/tsugite/contract/inspection';
import type { Protocol, ProtocolProviderOptions } from '#/tsugite/protocol/protocol';
