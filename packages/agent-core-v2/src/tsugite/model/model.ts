/**
 * `tsugite/model` domain (L2) — model configuration registry contract.
 *
 ...
 * global and shared across sessions. Tsugite has no persistence — it defines
 ...
 * live in the persistence wrapper (`app/tsugiteConfig/configSection`).
 ...
 * schema ≡ type pin in `app/tsugiteConfig/configSection` compares equal
...
/**
 * The in-memory model registry. Tsugite owns the state and the change events;
