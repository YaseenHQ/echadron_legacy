/**
 * `tsugite/model` domain (L2) — `ModelRequesterImpl`, the request executor.
 *
...
import { APIStatusError, isAbortError, VideoUploadUnsupportedError } from '#/tsugite/contract/errors';
import { generate, type GenerateResult } from '#/tsugite/contract/generate';
import type {
  ChatProvider,
  GenerateOptions,
...
import { translateProviderError } from '#/tsugite/protocol/errors';
