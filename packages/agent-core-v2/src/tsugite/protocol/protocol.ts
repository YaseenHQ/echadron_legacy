/**
 * `tsugite/protocol` domain (L1) — wire protocol identity and the adapter
 * registry contract.
 *
 ...
 * (`tsugite/provider/protocolAdapterRegistry`).
 */
...
import type { InspectionSource } from '#/tsugite/contract/inspection';
