...
export interface SessionStateSnapshot {
  ...
  'workspaceCommand.pendingMainInjections': (/* ContextMessage — packages/agent-core-v2/src/agent/contextMemory/types.ts */ /* Message — packages/agent-core-v2/src/tsugite/contract/message.ts */ {
    readonly role: /* Role — packages/agent-core-v2/src/tsugite/contract/message.ts */ 'user' | 'system' | 'assistant' | 'tool';
    readonly name?: string;
    readonly content: (/* ContentPart — packages/agent-core-v2/src/tsugite/contract/message.ts */ /* TextPart — packages/agent-core-v2/src/tsugite/contract/message.ts */ {
      type: 'text';
      text: string;
    } | /* ThinkPart — packages/agent-core-v2/src/tsugite/contract/message.ts */ {
      type: 'think';
      think: string;
      encrypted?: string;
    } | /* ImageURLPart — packages/agent-core-v2/src/tsugite/contract/message.ts */ {
      type: 'image_url';
      imageUrl: {
        url: string;
        id?: string;
      };
    } | /* AudioURLPart — packages/agent-core-v2/src/tsugite/contract/message.ts */ {
      type: 'audio_url';
      audioUrl: {
        url: string;
        id?: string;
      };
    } | /* VideoURLPart — packages/agent-core-v2/src/tsugite/contract/message.ts */ {
      type: 'video_url';
      videoUrl: {
        url: string;
        id?: string;
      };
    } | /* OpenAICompactionPart — packages/agent-core-v2/src/tsugite/contract/message.ts */ {
    ...
    readonly toolCalls: /* ToolCall — packages/agent-core-v2/src/tsugite/contract/message.ts */ {
      type: 'function';
      id: string;
      name: string;
    ...
    readonly tools?: readonly /* Tool — packages/agent-core-v2/src/tsugite/contract/tool.ts */ {
      name: string;
      description: string;
...
export interface AgentStateSnapshot {
  ...
  'llmRequester.turnConfigs': Map<number, /* TurnRequestConfig — packages/agent-core-v2/src/agent/llmRequester/llmRequesterService.ts */ {
    readonly resolved: /* ProfileModelContext — packages/agent-core-v2/src/agent/profile/profile.ts */ {
      ...
      readonly modelCapabilities: /* ModelCapability — packages/agent-core-v2/src/tsugite/contract/capability.ts */ {
      ...
      readonly thinkingLevel: /* ThinkingEffort — packages/agent-core-v2/src/tsugite/contract/provider.ts */ 'off' | 'on' | (string & {});
      readonly reservedContextSize: number | undefined;
      readonly compactionTriggerRatio: number | undefined;
    };
    readonly params: /* ModelRequestParams — packages/agent-core-v2/src/tsugite/model/modelRequester.ts */ {
      readonly cacheKey?: string;
      readonly sampling?: /* SamplingOptions — packages/agent-core-v2/src/tsugite/contract/provider.ts */ {
  ...
  'media.resolved': Map<string, /* ContentPart — packages/agent-core-v2/src/tsugite/contract/message.ts */ /* TextPart — packages/agent-core-v2/src/tsugite/contract/message.ts */ {
    type: 'text';
    text: string;
  } | /* ThinkPart — packages/agent-core-v2/src/tsugite/contract/message.ts */ {
    type: 'think';
  ...
  'usage.currentTurn': /* TokenUsage — packages/agent-core-v2/src/tsugite/contract/usage.ts */ {
    inputOther: number;
    output: number;
