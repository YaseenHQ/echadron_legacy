/**
 * `tsugite/model` ModelRequesterImpl tests — request execution against a fake
...
import { APIStatusError, createAbortError } from '#/tsugite/contract/errors';
...
import type { IProtocolAdapterRegistry } from '#/tsugite/protocol/protocol';
import type { Model } from '#/tsugite/model/catalog';
import type { ModelRequestEvent } from '#/tsugite/model/modelRequester';
import { effectiveMaxCompletionTokens } from '#/tsugite/model/modelRequester';
import { buildStreamTiming, ModelRequesterImpl } from '#/tsugite/model/modelRequesterImpl';
