/**
 * `tsugite/contract` generate() — the stream-merging generation driver.
 *
...
import { APIEmptyResponseError } from '#/tsugite/contract/errors';
import { generate, type GenerateResult } from '#/tsugite/contract/generate';
import type { Message, StreamedMessagePart, ToolCall } from '#/tsugite/contract/message';
import type {
  ChatProvider,
  FinishReason,
  GenerateOptions,
