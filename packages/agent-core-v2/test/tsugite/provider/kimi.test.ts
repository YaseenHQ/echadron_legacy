/**
 * `tsugite/provider` Kimi trait probes (probe 6) — every Kimi deviation is a
...
import type { ProtocolTrait, TraitContext } from '#/tsugite/protocol/protocolTrait';
import { KimiFiles } from '#/tsugite/provider/providers/kimi/kimi-files';
import {
  convertKimiTool,
  kimiAnthropicTrait,
  kimiOpenAITrait,
