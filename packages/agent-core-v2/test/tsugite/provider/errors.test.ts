/**
 * `tsugite/provider` abort-classification probes (probe 3) — a user
...
import type { ProtocolAdapterConfig } from '#/tsugite/protocol/protocol';
import { traitConvertError, type TraitContext } from '#/tsugite/protocol/protocolTrait';
import { convertAnthropicError } from '#/tsugite/provider/bases/anthropic/anthropic';
import { convertOpenAIError } from '#/tsugite/provider/bases/openai/openai-common';
import { OpenAIResponsesStreamedMessage } from '#/tsugite/provider/bases/openai/openai-responses';
import { composeOpenAIChatHooks } from '#/tsugite/provider/bases/openai/openaiHooks';
import { kimiAnthropicTrait, kimiOpenAITrait } from '#/tsugite/provider/providers/kimi/kimi.contrib';
import { classifyKimiQuotaError } from '#/tsugite/provider/providers/kimi/kimi-errors';
