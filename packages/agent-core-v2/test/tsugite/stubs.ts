/**
 * Shared test stubs for the `tsugite/model` suites:
...
import type { IModelOAuthTokens } from '#/tsugite/model/modelOAuth';
...
/**
 * The tsugite-side OAuth port stub (`IModelOAuthTokens`), mirroring what the
 * real `app/tsugiteConfig` adapter does over `IOAuthService`: a programmable
