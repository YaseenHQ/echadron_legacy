/**
 * `app/tsugiteConfig` envOverlay tests — the `KIMI_MODEL_*` effective overlay:
 *
...
import { ENV_MODEL_PROVIDER_KEY } from '#/app/tsugiteConfig/configSection';
import '#/tsugite/provider/providers/kimi/kimi.contrib';
import '#/tsugite/provider/providers/standard.contrib';
import { ENV_MODEL_ALIAS_KEY, kimiModelEnvOverlay } from '#/app/tsugiteConfig/envOverlay';
