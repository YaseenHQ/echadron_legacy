/**
 * `app/tsugiteConfig` models.dev import tests — `IModelsDevImportService`:
 *
...
} from '#/app/tsugiteConfig/modelsDevUpstream';
import { MODELS_SECTION, PROVIDERS_SECTION } from '#/app/tsugiteConfig/configSection';
...
import { IModelsDevImportService } from '#/app/tsugiteConfig/modelsDevImport';
import '#/app/tsugiteConfig/modelsDevImportService';
import { IModelCatalog, type ProviderCatalogItem } from '#/tsugite/model/catalog';
import type { ModelsSection } from '#/tsugite/model/model';
import type { ProvidersSection } from '#/tsugite/provider/provider';
...
function stubTsugiteConfig(): ITsugiteConfigService {
  return { _serviceBrand: undefined, ready: Promise.resolve() } as ITsugiteConfigService;
}
...
function createHost(sections: Record<string, unknown> = {}): {
  ...
  const host = createScopedTestHost([
    ...
    [ITsugiteConfigService, stubTsugiteConfig()],
