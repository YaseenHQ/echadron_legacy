/**
 * `app/tsugiteConfig` discovery tests — `IProviderDiscoveryService`:
 *
...
import { IProviderDiscoveryService } from '#/app/tsugiteConfig/discovery';
import '#/app/tsugiteConfig/discoveryService';
import { MODEL_CATALOG_SECTION } from '#/app/tsugiteConfig/configSection';
import { ITsugiteConfigService } from '#/app/tsugiteConfig/tsugiteConfig';
import '#/app/tsugiteConfig/tsugiteConfigService';
import '#/tsugite/model/errors';
import { HostRequestHeaders, IHostRequestHeaders } from '#/tsugite/model/hostRequestHeaders';
import {
  IModelService,
  type ModelRecord,
} from '#/tsugite/model/model';
import '#/tsugite/model/modelService';
import {
  IProviderService,
  type ProviderConfig,
} from '#/tsugite/provider/provider';
import '#/tsugite/provider/providerService';
import '#/tsugite/provider/providers/kimi/kimi.contrib';
import '#/tsugite/provider/providers/standard.contrib';

import { StubConfigService, stubOAuthService, stubTokenProvider } from '../../tsugite/stubs';
...
async function createHost(
  ...
  // config, and the bridge's config → tsugite sync is what carries them into
  ...
  const bridge = host.app.accessor.get(ITsugiteConfigService);
  await bridge.ready;
  return {
    host,
    config,
