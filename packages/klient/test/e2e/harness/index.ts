/**
 * `@yaseenhq/server-e2e` — wire-level test client for the kimi-code server.
 *
 ...
 *
 * Re-exports `@yaseenhq/protocol` types are NOT bundled here — scenarios
 * that want them import from `@yaseenhq/protocol` directly.
 */
