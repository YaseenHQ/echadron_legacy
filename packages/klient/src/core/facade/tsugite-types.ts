/**
 * Public input types for the merged `global.tsugite` facade — the shapes
...
import type { Message, StreamedMessagePart } from '@yaseenhq/agent-core-v2/tsugite/contract/message';
...
import type { ResponseFormat } from '@yaseenhq/agent-core-v2/tsugite/contract/provider';
...
/** Named provider configuration passed to `tsugite.addProvider(id, config)`. */
 ...
 * Passed as a single object to `tsugite.addProvider(config)`.
 */
